...
Sleep Metrics,
Personality Test,
Family">Personal data collected <i className="fa fa-question-circle fa-lg fa-fw"></i></div>
...
Research,
Unknown">Where is my data being sent? <i className="fa fa-question-circle fa-lg fa-fw"></i></div>
