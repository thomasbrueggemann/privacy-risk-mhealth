		...
		return (
			<div className="weights">
				...
				<p>
					...
					<span className="reverse">21 grubnenorC</span><br />
					<span className="reverse">nehcrikslegnE 66715</span><br />
				</p>
				...
				<p>
					...
					{" "}
					<a
						href="http://link.springer.com/chapter/10.1007%2F978-3-319-44760-5_12"
						target="_blank"
					>
					...
					by the
					{" "}
					<a href="http://se.uni-kassel.de/" target="_blank">
